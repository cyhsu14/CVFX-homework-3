...
|結果圖|描述|
|:---:|---|
|<img src="./img/giantTree.png" width="600px">|嘗試要長出一柱擎天的樹<br><br>結果：<br>失敗，只有地面上多出了一棵沒那麼高的樹，<br>還有被畫到的建築物變高了。|
|<img src="./img/groundTree.png" width="600px">|嘗試在地面上長出一排矮木<br><br>結果：<br>成功，雖然長出來的樹只有少少幾株，<br>但在這個很明顯是水泥地的環境的這張圖中，<br>以我的角度看來有太多樹也是不太合理的。|
|<img src="./img/skyTree.png" width="600px">|嘗試天外飛來一樹<br><br>結果：<br>失敗，而的確常識上來說天空並不會飄出一棵樹。|
